    ...
    <div className='w-56'>
        ...
        <div className='flex flex-col items-center bg-white grow shadow rounded-md overflow-hidden'>
            <div className='relative h-32'>
                ...
                <Avatar className='border-white border-2 !h-16 !w-16 absolute bottom-10 left-20 scale-125' src={Profile} />
            </div>
            <h1 className="font-semibold text-lg">Patrick Halim</h1>
            <h2 className="text-sm text-neutral-500 text-center mx-3">Foodie | Creator of MunchIn</h2>
